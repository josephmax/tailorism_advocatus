 ...
 */
myApp.controller('myRecScanUserCtrl', ['$scope', '$location', 'dataService', function ($scope, $location, dataService) {
    var userList = {
        data: [],
        pager: {}
    };
    ...
    $scope.recScanUserList = userList;
    $scope.user = {
        user: '',
        user_profit: '',
        profitpp: profitpp
    ...
    dataService.getRecUserDetail(data, showScanUserList);

    function showScanUserList(res) {
